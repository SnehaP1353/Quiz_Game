...
def quiz(y):
    ...
    Button(frame1,text="22",font=("Arial",30,"bold"),bg="light pink",command=a1_wrong).grid(row=3,column=3)

    Label(frame2,text="Output of 2**3 ?",font=("Arial",40,"bold")).grid(row=2,column=2)
    ...
    Label(frame3,text="Output of np.arange(1,5) ?",font=("Arial",30,"bold")).grid(row=2,column=2)
    ...
    Label(frame5,text="Output of 2*12 ?",font=("Arial",40,"bold")).grid(row=2,column=2)
    Button(frame5,text="24",font=("Arial",30,"bold"),bg="light blue",command=a5_wrong).grid(row=3,column=1)
    Button(frame5,text="28",font=("Arial",30,"bold"),bg="light green",command=a5_right).grid(row=3,column=2)
...
def a1_right():
    ...
    Label(frame1,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a1_wrong():
    Label(frame1,text="Incorrect",font=("Arial",30,"bold"),background="red",fg="yellow").grid(row=1,column=2)
    Label(frame1,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a2_right():
    Label(frame2,text="Correct",font=("Arial",30,"bold"),background="green",fg="yellow").grid(row=1,column=2)
    Label(frame2,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a2_wrong():
    Label(frame2,text="Incorrect",font=("Arial",30,"bold"),background="red",fg="yellow").grid(row=1,column=2)
    Label(frame2,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a3_right():
    Label(frame3,text="Correct",font=("Arial",30,"bold"),background="green",fg="yellow").grid(row=1,column=2)
    Label(frame3,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a3_wrong():
    Label(frame3,text="Incorrect",font=("Arial",30,"bold"),background="red",fg="yellow").grid(row=1,column=2)
    Label(frame3,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a4_right():
    Label(frame4,text="Correct",font=("Arial",30,"bold"),background="green",fg="yellow").grid(row=1,column=2)
    Label(frame4,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a4_wrong():
    Label(frame4,text="Incorrect",font=("Arial",30,"bold"),background="red",fg="yellow").grid(row=1,column=2)
    Label(frame4,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a5_right():
    Label(frame5,text="Correct",font=("Arial",30,"bold"),background="green",fg="yellow").grid(row=1,column=2)
    Label(frame5,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)

def a5_wrong():
    Label(frame5,text="Incorrect",font=("Arial",30,"bold"),background="red",fg="yellow").grid(row=1,column=2)
    Label(frame5,text="Marks obatained : 1",font=("Arial",30,"bold"),background="black",fg="white").grid(row=1,column=3)
